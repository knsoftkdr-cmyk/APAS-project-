...
const DEFAULT_PERMISSIONS: Record<string, string[]> = {
  admin:     ["Home", "Reports", "Alerts", "Admin Panel", "AI Tutor", "School Intelligence", "Security Center", "Billing", "Academic Calendar", "Houses", "Semester Engine", "Report Cards", "Attendance", "Safeguarding & Child Protection", "Rotation Schedules", "SEN Management", "School Quality Index"],
  principal: ["Home", "Reports", "Alerts", "Admin Panel", "AI Tutor", "School Intelligence", "Security Center", "Billing", "Academic Calendar", "Houses", "Semester Engine", "Report Cards", "Invigilation", "Exam Seating", "Hall Tickets", "Attendance", "Safeguarding & Child Protection", "Rotation Schedules", "SEN Management", "School Quality Index"],
  hod:       ["Home", "Reports", "Assessments", "Analytics", "Academic Calendar", "Houses", "Safeguarding & Child Protection"],
  teacher:   ["Home", "Reports", "Lesson Plans", "Analytics", "Requests", "Academic Calendar", "Houses", "Semester Engine", "Attendance", "Group Projects", "Safeguarding & Child Protection"],
