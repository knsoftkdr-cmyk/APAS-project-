  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div>
        ...
        <p className="text-xs text-[#6b6b8a] mt-4 leading-relaxed break-words">{varkDescription}</p>
        {varkNotSure > 0 && (
      ...
      <div>
        ...
        <div className="bg-white border border-[#e2e0d8] rounded-xl overflow-x-auto">
      ...
      {/* FOOTER */}
      <div className="border-t border-[#e2e0d8] pt-4 flex flex-col md:flex-row justify-between items-center gap-2">
