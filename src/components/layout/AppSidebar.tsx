...
const navItems: Array<{
  ...
  { title: "Adaptive Homework", icon: ClipboardList, path: "/adaptive-homework", roles: ["student"], module: "Homework" },
...
{ title: "Surveys", icon: ClipboardList, path: "/surveys", roles: ["teacher", "admin", "school_admin", "hod", "student"] },
  ...
  { title: "Adaptive Homework", icon: Wand2, path: "/adaptive-homework/generate", roles: ["admin", "principal", "hod", "school_admin"] },
