...
const navItems: Array<{
  ...
  { title: "Report Cards", icon: FileText, path: "/report-cards", roles: ["admin", "principal", "school_admin", "teacher", "student"], module: "Report Cards" },
  ...
  const visibleItems = (needsPermCheck && permsLoading) ? [] : navItems
    .filter((item) => {
      ...
      if (profile?.role === "student" || profile?.role === "parent") {
        ...
        const studentModules = ["Home", "Assessments", "Academic Tests", "Homework", "Gamification", "Leaderboard", "Predictions", "AI Tutor", "Academic Calendar", "Semester Engine", "Report Cards", "Houses"];
