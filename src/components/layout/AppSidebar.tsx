...
const navItems: Array<{
  ...
  { title: "Requests", icon: Send, path: "/requests", roles: ["admin", "principal", "hod", "student", "parent"], module: "Requests" },
  ...
  { title: "Homework", icon: LayoutDashboard, path: "/dashboard", roles: ["admin", "principal", "hod", "teacher", "parent"], tourId: "nav-home", module: "Homework" },
  { title: "Gamification", icon: Trophy, path: "/gamification", roles: ["admin", "principal", "hod", "teacher", "parent"], tourId: "nav-gamification", module: "Gamification" },
  { title: "Leaderboard", icon: Trophy, path: "/leaderboard", roles: ["admin", "principal", "hod", "teacher", "parent"], module: "Leaderboard" },
  ...
  { title: "AI Tutor", icon: Bot, path: "/ai-tutor", roles: ["admin", "principal", "hod", "teacher", "parent"], tourId: "nav-ai-tutor", module: "AI Tutor", subItem: { title: "AI Career Coach", path: "/ai-tutor?mode=career", icon: Compass } },
