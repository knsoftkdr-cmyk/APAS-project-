...
export function OnboardingFlow() {
  ...
  const saveClass = async (classGrade: string) => {
    try {
      const { error } = await supabase
        .from("profiles")
      ...
      // Do NOT advance step on error — user stays on class modal
    }
  };
