...
import knowledgegraphbanner from "@/assets/knowledgegraph-banner.png";
interface Chunk {
  id: string;
  subject: string;
  curriculum: string;
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-black/80 mt-1">
                Concept relationships, topic dependencies
              </p>
                  ...
                  <img
                    src={knowledgegraphbanner}
                    alt="Knowledge Graph Banner"
